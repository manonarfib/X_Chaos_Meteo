...
csv_path_train = "checkpoints_input_wout_precip/train_log.csv"
csv_path_val   = "checkpoints_input_wout_precip/validation_log.csv"
...
plt.savefig("checkpoints_input_wout_precip/loss_curve.png", dpi=150)
plt.show()
