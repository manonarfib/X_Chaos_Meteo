...
def save_maps_europe_multi(
    ...
    tp_cmap = _cmap_with_white_bad(tp_cmap)
...
def main():
    ...
    out_dir = f"inference/compare_3models_v2/sample{SAMPLE_IDX}"
    ...
    cmap_green_to_red = truncate_colormap(plt.get_cmap('jet'), 0.45, 1.0)
